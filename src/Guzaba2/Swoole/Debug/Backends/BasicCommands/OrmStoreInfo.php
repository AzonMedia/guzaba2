...
*/
    ...
    {
        $ret = sprintf(t::_('%s avilable commands:%s'), self::get_class_name(), PHP_EOL);
    ...
    public static function help(?string $command = null) : string
    {
        ...
        if (null === $command) {
            ...
            return self::handles_commands();
        } else {
            return sprintf(t::_('%s: %s'), $command, self::$commands[$command]['help_str']);
        }
    }
